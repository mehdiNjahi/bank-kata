...
public class TestBankingServicesImpl {
    ...
    private IndividualBankClient bankClient = new IndividualBankClient("yves","pierre",null,"plessis robinson");
    private Bank bank = new Bank("Kata");

    private IBankOperation bankOperation;

    @BeforeEach
    void setUp() {
        account = new SavingsAccount("FR77015");
    ...
    void shouldReturnValidAmountDeposited() throws InvalidOperationException {
        ...
        assertThat("FR77015").isEqualTo(bankClient.getAccounts().get(0).getNumber());
    }
